...
class DatabaseDataWorker {
    ...
    private void insertCourse(String courseId, String title) {
        ...
        long newRowId = database.insert(NoteKeeperDatabaseContract.CourseInfoEntry.TABLE_NAME, null, values);
    }
    ...
    private void insertNote(String courseId, String title, String text) {
        ...
        long newRowId = database.insert(NoteKeeperDatabaseContract.NoteInfoEntry.TABLE_NAME, null, values);
    }
}

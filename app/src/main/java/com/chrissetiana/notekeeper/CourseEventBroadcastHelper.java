...
public class CourseEventBroadcastHelper {
    public static final String ACTION_COURSE_EVENT = "com.chrissetiana.notekeeper.action.COURSE_EVENT";
    public static final String EXTRA_COURSE_ID = "com.chrissetiana.notekeeper.extra.COURSE_ID";
    public static final String EXTRA_COURSE_MESSAGE = "com.chrissetiana.notekeeper.extra.COURSE_MESSAGE";
